            ...
            >
              <div className="relative group">
                ...
                <button
                  ...
                  title="Add to Cart"
                  className="absolute top-3 right-3 bg-indigo-600 group-hover:bg-indigo-700 text-white p-2 rounded-full shadow transition-all duration-200"
                >
              ...
              <div className="p-4 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-center mt-auto mb-4">
                  ...
                  <span className="text-green-600 text-sm font-medium">Stock: {item.stock}</span>
                </div>
